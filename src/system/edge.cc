...
namespace tchecker {
  ...
  namespace system {
    ...
    edge_t::edge_t(tchecker::process_id_t pid,
    ...
    loc_edges_maps_t::edges(tchecker::loc_id_t loc) const
    {
      if (loc >= _loc_to_edges.size())
        return tchecker::make_range<tchecker::system::edges_collection_const_iterator_t>
        (_empty_edges.begin(), _empty_edges.end());
      return tchecker::make_range<tchecker::system::edges_collection_const_iterator_t>
      (_loc_to_edges[loc].begin(), _loc_to_edges[loc].end());
    }
      

    tchecker::range_t<tchecker::system::edges_collection_const_iterator_t>
    loc_edges_maps_t::edges(tchecker::loc_id_t loc, tchecker::event_id_t event) const
    {
      if (loc >= _loc_event_to_edges.size() || event >= _loc_event_to_edges[loc].size())
        return tchecker::make_range<tchecker::system::edges_collection_const_iterator_t>
        (_empty_edges.begin(), _empty_edges.end());
      return tchecker::make_range<tchecker::system::edges_collection_const_iterator_t>
      (_loc_event_to_edges[loc][event].begin(), _loc_event_to_edges[loc][event].end());
    }
    ...
    edges_t::edges_t(tchecker::system::edges_t const & edges)
    : _loc_edges_maps(2)
    {
      add_edges(edges);
    }
    ...
    void edges_t::add_edge(tchecker::process_id_t pid,
                           tchecker::loc_id_t src,
                           tchecker::loc_id_t tgt,
                           tchecker::event_id_t event_id,
                           tchecker::system::attributes_t const & attr)
    ...
    tchecker::range_t<tchecker::system::edges_t::const_iterator_t>
    edges_t::outgoing_edges(tchecker::loc_id_t loc) const
    {
    ...
    tchecker::range_t<tchecker::system::edges_t::const_iterator_t>
    edges_t::outgoing_edges(tchecker::loc_id_t loc, tchecker::event_id_t event) const
    {
    ...
    tchecker::range_t<tchecker::system::edges_t::const_iterator_t>
    edges_t::incoming_edges(tchecker::loc_id_t loc) const
    {
    ...
    tchecker::range_t<tchecker::system::edges_t::const_iterator_t>
    edges_t::incoming_edges(tchecker::loc_id_t loc, tchecker::event_id_t event) const
    {
    ...
    tchecker::system::loc_edges_maps_t const & edges_t::outgoing_edges_maps() const
    {
      return _loc_edges_maps[tchecker::system::OUTGOING_EDGE];
    }
    

    tchecker::system::loc_edges_maps_t const & edges_t::incoming_edges_maps() const
    {
    ...
    bool edges_t::is_edge(tchecker::edge_id_t id) const
    {
      return id < _edges.size();
    }
