...
namespace tchecker {
  ...
  namespace system {
    ...
    void intvars_t::add_intvar(std::string const & name,
                               ...
                               tchecker::system::attributes_t const & attr)
    {
      ...
      assert(_integer_variables.size() == _integer_variables_attr.size());
    ...
    bool intvars_t::is_intvar(std::string const & name) const
    {
      return _integer_variables.is_variable(name);
    }
