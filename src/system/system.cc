  ...
  namespace system {
    ...
    public:
      /*!
       \brief Constructor
       */
      system_builder_t(tchecker::system::system_t & system)
      : _system(system)
      {}
      ...
      {
        _system.add_process(d.name(), d.attributes());
      }
      ...
      {
        _system.add_event(d.name(), d.attributes());
      }
    ...
    system_t::system_t(std::string const & name, tchecker::system::attributes_t const & attr)
    : _name(name), _attr(attr)
    {}
    
    
    system_t::system_t(tchecker::parsing::system_declaration_t const & sysdecl)
    : _name(sysdecl.name()), _attr(sysdecl.attributes())
    {
    ...
    void system_t::add_clock(std::string const & name,
                             tchecker::clock_id_t size,
    ...
    void system_t::add_edge(tchecker::process_id_t pid,
    ...
    void system_t::add_intvar(std::string const & name,
    ...
    void system_t::add_location(tchecker::process_id_t pid,
