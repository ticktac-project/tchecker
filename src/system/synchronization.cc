...
namespace tchecker {
  ...
  namespace system {
    ...
    sync_constraint_t::sync_constraint_t(tchecker::process_id_t pid,
    ...
    synchronization_t::synchronization_t(tchecker::sync_id_t id,
    ...
    tchecker::system::synchronization_t const &
    synchronizations_t::synchronization(tchecker::sync_id_t id) const
    {
      if (id >= _syncs.size())
    ...
    tchecker::range_t<tchecker::system::synchronizations_t::const_iterator_t>
    synchronizations_t::synchronizations() const
    {
