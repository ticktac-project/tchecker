...
namespace tchecker {
  ...
  vedge_t::vedge_t(unsigned int size)
  : tchecker::edge_array_t(std::make_tuple(size), std::make_tuple(tchecker::NO_EDGE))
  {}
  
  
  tchecker::vedge_t::iterator_t vedge_t::begin()
  {
    return tchecker::vedge_t::iterator_t(tchecker::valid_edge_id,
                                         tchecker::edge_array_t::begin(),
  ...
  {
    return tchecker::vedge_t::const_iterator_t(tchecker::valid_edge_id,
                                               tchecker::edge_array_t::begin(),
                                               tchecker::edge_array_t::end());
  }
  ...
  tchecker::vedge_t::array_iterator_t vedge_t::begin_array()
  {
    return tchecker::edge_array_t::begin();
  }
    
  
  tchecker::vedge_t::array_iterator_t vedge_t::end_array()
  {
    return tchecker::edge_array_t::end();
  }
    

  tchecker::vedge_t::const_array_iterator_t vedge_t::begin_array() const
  {
    return tchecker::edge_array_t::begin();
  }
    

  tchecker::vedge_t::const_array_iterator_t vedge_t::end_array() const
  {
    return tchecker::edge_array_t::end();
  }
  ...
  std::ostream & output(std::ostream & os,
                        ...
                        tchecker::system::system_t const & system)
  {
  ...
  int lexical_cmp(tchecker::vedge_t const & vedge1, tchecker::vedge_t const & vedge2)
  {
    ...
    (vedge1.begin(), vedge1.end(), vedge2.begin(), vedge2.end(),
     [] (tchecker::edge_id_t id1, tchecker::edge_id_t id2) -> int
     {
