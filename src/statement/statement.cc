...
tchecker::statement_t * statement_t::clone() const { return this->do_clone(); }

void statement_t::visit(tchecker::statement_visitor_t & v) const { this->do_visit(v); }
...
std::ostream & operator<<(std::ostream & os, tchecker::statement_t const & stmt) { return stmt.do_output(os); }
...
std::ostream & nop_statement_t::do_output(std::ostream & os) const { return os << "nop"; }

tchecker::statement_t * nop_statement_t::do_clone() const { return new tchecker::nop_statement_t(); }

void nop_statement_t::do_visit(tchecker::statement_visitor_t & v) const { v.visit(*this); }
...
std::ostream & assign_statement_t::do_output(std::ostream & os) const { return os << *_lvalue << "=" << *_rvalue; }
...
void assign_statement_t::do_visit(tchecker::statement_visitor_t & v) const { v.visit(*this); }
...
std::ostream & sequence_statement_t::do_output(std::ostream & os) const { return os << *_first << "; " << *_second; }
...
void sequence_statement_t::do_visit(tchecker::statement_visitor_t & v) const { v.visit(*this); }

// if_statement_t

if_statement_t::if_statement_t(tchecker::expression_t const * cond, tchecker::statement_t const * then_stmt,
...
{
  return new tchecker::if_statement_t(_condition->clone(), _then_stmt->clone(), _else_stmt->clone());
}

void if_statement_t::do_visit(tchecker::statement_visitor_t & v) const { v.visit(*this); }

// while_statement_t

while_statement_t::while_statement_t(tchecker::expression_t const * cond, tchecker::statement_t const * stmt)
...
{
  return new tchecker::while_statement_t(_condition->clone(), _stmt->clone());
}

void while_statement_t::do_visit(tchecker::statement_visitor_t & v) const { v.visit(*this); }

// local_var_statement_t

local_var_statement_t::local_var_statement_t(tchecker::var_expression_t const * variable) : _variable(variable)
{
  if (variable == nullptr)
...
local_var_statement_t::local_var_statement_t(tchecker::var_expression_t const * variable, tchecker::expression_t const * init)
...
void local_var_statement_t::do_visit(tchecker::statement_visitor_t & v) const { v.visit(*this); }

// local_array_statement_t

local_array_statement_t::local_array_statement_t(tchecker::var_expression_t const * variable,
...
void local_array_statement_t::do_visit(tchecker::statement_visitor_t & v) const { v.visit(*this); }
