...
sync_zone_computer_t::sync_zone_computer_t(tchecker::clock_id_t offset_dim, tchecker::clock_id_t refcount,
...
sync_zone_computer_t::sync_zone_computer_t(tchecker::offset_dbm::details::sync_zone_computer_t && c)
    : _offset_dbm(c._offset_dbm), _offset_dim(std::move(c._offset_dim)), _refcount(std::move(c._refcount)), _refmap(c._refmap)
{
...
enum tchecker::dbm::status_t sync_zone_computer_t::sync_zone(tchecker::dbm::db_t const * const offset_dbm,
                                                             tchecker::clock_id_t offset_dim, tchecker::dbm::db_t * dbm,
