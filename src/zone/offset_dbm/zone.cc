...
bool zone_t::empty() const { return tchecker::offset_dbm::is_empty_0(dbm_ptr(), _dim); }
...
bool zone_t::operator!=(tchecker::offset_dbm::zone_t const & zone) const { return !(*this == zone); }
...
std::size_t zone_t::hash() const { return tchecker::offset_dbm::hash(dbm_ptr(), _dim); }
