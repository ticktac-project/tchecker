...
namespace tchecker {
  ...
  namespace dbm {
    ...
    bool zone_t::is_empty() const
    {
      return tchecker::dbm::is_empty_0(dbm_ptr(), _dim);
    }
    
    
    bool zone_t::is_universal_positive() const
    {
      return tchecker::dbm::is_universal_positive(dbm_ptr(), _dim);
    }
    ...
    bool zone_t::alu_le(tchecker::dbm::zone_t const & zone,
    ...
    {
      tchecker::dbm::universal_positive(dbm_ptr(), _dim);
    }
