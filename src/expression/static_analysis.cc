...
namespace tchecker {
  ...
  namespace details {
    ...
    public:
       ...
       */
      const_expression_evaluator_t(tchecker::details::const_expression_evaluator_t const & evaluator)
      ...
      /*!
       ...
       \return this
       */
      tchecker::details::const_expression_evaluator_t &
      operator= (tchecker::details::const_expression_evaluator_t const & evaluator)
      {
        if (this != &evaluator)
          _value = evaluator._value;
        return *this;
       ...
       */
      tchecker::details::const_expression_evaluator_t &
      operator= (tchecker::details::const_expression_evaluator_t && evaluator)
      {
        if (this != &evaluator)
          _value = std::move(evaluator._value);
        return *this;
      ...
      virtual void visit(tchecker::unary_expression_t const & expr)
      {
        ...
        switch (expr.unary_operator()) {
          case tchecker::EXPR_OP_NEG:   _value = - _value; break;
          case tchecker::EXPR_OP_LNOT:  _value = ! _value; break;
      ...
      virtual void visit(tchecker::binary_expression_t const & expr)
      {
        ...
        switch (expr.binary_operator()) {
          ...
          case tchecker::EXPR_OP_EQ:      _value = left == right; break;
          case tchecker::EXPR_OP_NEQ:     _value = left != right; break;
          case tchecker::EXPR_OP_GE:      _value = left >= right; break;
          case tchecker::EXPR_OP_GT:      _value = left > right;  break;
          case tchecker::EXPR_OP_MINUS:   _value = left - right;  break;
          case tchecker::EXPR_OP_PLUS:    _value = left + right;  break;
          case tchecker::EXPR_OP_TIMES:   _value = left * right;  break;
          case tchecker::EXPR_OP_DIV:     _value = left / right;  break;
          case tchecker::EXPR_OP_MOD:     _value = left % right;  break;
          default:                        throw std::runtime_error("incomplete switch statement");
        }
      }
  ...
  namespace details {
    ...
    public:
       ...
       */
      tchecker::range_t<tchecker::variable_id_t> range() const
      {
        return tchecker::make_range(_first, _first + _size);
      }
  ...
  void extract_variables(tchecker::typed_expression_t const & expr,
                         std::unordered_set<tchecker::clock_id_t> & clocks,
                         std::unordered_set<tchecker::intvar_id_t> & intvars)
  {
