...
namespace tchecker {
  ...
  namespace ta {
    ...
    : tchecker::syncprod::system_t(sysdecl)
    {
    ...
    : tchecker::syncprod::system_t(system)
    {
      compute_from_syncprod_system();
    }
      

    system_t::system_t(tchecker::syncprod::system_t const & system)
    : tchecker::syncprod::system_t(system)
    {
      compute_from_syncprod_system();
    }
    ...
    tchecker::range_t<tchecker::ta::system_t::labels_const_iterator_t>
    system_t::labels(tchecker::loc_id_t id) const
    {
      assert(is_location(id));
                             ...
                             std::string const & context)
    {
      ...
      for (auto && [key, value] : attrs) {
        ...
        = tchecker::parsing::parse_expression(context, value, tchecker::log);
    ...
    void system_t::set_invariant
    (tchecker::loc_id_t id,
     tchecker::range_t<tchecker::system::attributes_t::const_iterator_t> const & invariants)
    {
      std::string context = "In process "
      + tchecker::syncprod::system_t::process_name(location(id)->pid())
      + ", location "
      + tchecker::syncprod::system_t::location(id)->name()
      + ", invariant";
    ...
    {
      std::string context = "In process "
      + tchecker::syncprod::system_t::process_name(edge(id)->pid())
      + ", edge from "
      + tchecker::syncprod::system_t::location(edge(id)->src())->name()
      + " to "
      + tchecker::syncprod::system_t::location(edge(id)->tgt())->name()
      + " with event "
      + tchecker::syncprod::system_t::event_name(edge(id)->event_id())
      + ", provided";
                        ...
                        std::string const & context)
    {
      ...
      for (auto && [key, value] : attrs) {
        ...
        = tchecker::parsing::parse_statement(context, value, tchecker::log);
