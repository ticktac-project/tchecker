...
namespace tchecker {
  ...
  namespace ta {
               ...
               tchecker::ta::initial_iterator_value_t const & initial_range)
    {
      ...
      tchecker::intvar_id_t intvars_size = intvars.flattened_size();
    ...
    ta_t::ta_t(tchecker::ta::system_t const & system)
    : _system(system)
    {}

    
    tchecker::range_t<tchecker::ta::initial_iterator_t> ta_t::initial()
    {
      return tchecker::ta::initial(_system);
    }
    

    enum tchecker::state_status_t ta_t::initialize(tchecker::ta::state_t & s,
                                                   tchecker::ta::transition_t & t,
                                                   tchecker::ta::initial_iterator_value_t const & v)
    {
      return tchecker::ta::initialize(_system, s.vloc_ptr(), s.intval_ptr(), t.vedge_ptr(),
                                      t.tgt_invariant_container(), v);
    }
    
    
    tchecker::range_t<tchecker::ta::outgoing_edges_iterator_t>
    ta_t::outgoing_edges(tchecker::ta::state_t const & s)
    {
      return tchecker::ta::outgoing_edges(_system, s.vloc_ptr());
    }
    

    enum tchecker::state_status_t ta_t::next(tchecker::ta::state_t & s,
                                             tchecker::ta::transition_t & t,
                                             tchecker::ta::outgoing_edges_iterator_value_t const & v)
    {
      return tchecker::ta::next(_system, s.vloc_ptr(), s.intval_ptr(), t.vedge_ptr(),
                                t.src_invariant_container(), t.guard_container(), t.reset_container(),
                                t.tgt_invariant_container(), v);
    }
    

    tchecker::ta::system_t const & ta_t::system() const
    {
      return _system;
    }
