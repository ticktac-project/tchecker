...
options_t::options_t(tchecker::covreach::options_t && options)
    : _node_covering(options._node_covering), _output_format(std::move(options._output_format)),
      _accepting_labels(options._accepting_labels), _algorithm_model(std::move(options._algorithm_model)), _os(options._os),
      _search_order(std::move(options._search_order)), _block_size(std::move(options._block_size)),
      _nodes_table_size(std::move(options._nodes_table_size)), _stats(options._stats)
{
  options._os = nullptr;
}
...
enum tchecker::covreach::options_t::node_covering_t options_t::node_covering() const { return _node_covering; }

enum tchecker::covreach::options_t::output_format_t options_t::output_format() const { return _output_format; }
...
enum tchecker::covreach::options_t::algorithm_model_t options_t::algorithm_model() const { return _algorithm_model; }

std::ostream & options_t::output_stream() const { return *_os; }

enum tchecker::covreach::options_t::search_order_t options_t::search_order() const { return _search_order; }

std::size_t options_t::block_size() const { return _block_size; }

std::size_t options_t::nodes_table_size() const { return _block_size; }

bool options_t::stats() const { return (_stats == 1); }
...
void options_t::set_stats(std::string const & value, tchecker::log_t & log) { _stats = 1; }
