...
options_t::options_t(tchecker::explore::options_t && options)
    : _output_format(std::move(options._output_format)), _explored_model(std::move(options._explored_model)), _os(options._os),
...
enum tchecker::explore::options_t::output_format_t options_t::output_format() const { return _output_format; }

enum tchecker::explore::options_t::explored_model_t options_t::explored_model() const { return _explored_model; }

std::ostream & options_t::output_stream() const { return *_os; }

enum tchecker::explore::options_t::search_order_t options_t::search_order() const { return _search_order; }
