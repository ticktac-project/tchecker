...
tchecker::tck_reach::zg_covreach::cex::cex_t * counter_example(tchecker::tck_reach::zg_covreach::graph_t const & g)
{
  return tchecker::tck_reach::counter_example_zg<tchecker::tck_reach::zg_covreach::graph_t>(g);
}

std::ostream & dot_output(std::ostream & os, tchecker::tck_reach::zg_covreach::cex::cex_t const & cex, std::string const & name)
{
