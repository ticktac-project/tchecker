...
zg_t::zg_t(std::shared_ptr<tchecker::ta::system_t const> const & system,
           ...
           std::unique_ptr<tchecker::zg::extrapolation_t> && extrapolation, std::size_t block_size, std::size_t table_size)
                             ...
                             std::size_t table_size)
{
  ...
  return new tchecker::zg::zg_t(system, std::move(semantics), std::move(extrapolation), block_size, table_size);
}
