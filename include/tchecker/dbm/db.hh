...
namespace tchecker {
  ...
  namespace dbm {
     ...
     */
    inline tchecker::dbm::db_t db(enum tchecker::dbm::comparator_t cmp, tchecker::dbm::db_t value)
    {
     ...
     */
    inline tchecker::dbm::db_t add(tchecker::dbm::db_t db, tchecker::dbm::db_t value)
    {
    ...
    /*!
     ...
     \return value of db
     */
    inline tchecker::dbm::db_t value(tchecker::dbm::db_t db)
    {
      return (db >> 1);
    }
