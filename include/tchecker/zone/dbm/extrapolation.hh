...
namespace tchecker {
  ...
  namespace dbm {
     ...
     */
    typedef void (*extra_M_t) (tchecker::dbm::db_t *, tchecker::clock_id_t, tchecker::dbm::db_t const *);
    
    
    /*!
     \brief Type of extrapolation function using LU clock bounds
     */
    typedef void (*extra_LU_t) (tchecker::dbm::db_t *, tchecker::clock_id_t, tchecker::dbm::db_t const *, tchecker::dbm::db_t const *);
