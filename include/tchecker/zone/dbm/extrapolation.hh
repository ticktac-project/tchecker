...
public:
   ...
   */
  template <class VLOC> void extrapolate(tchecker::dbm::db_t * dbm, tchecker::clock_id_t dim, VLOC const & loc_ids);
};
 ...
 */
template <extra_M_t EXTRAPOLATION> class global_M_extrapolation_t {
public:
  /*!
   \brief Constructor
   \param model : a model
   ...
   */
  template <class MODEL> explicit global_M_extrapolation_t(MODEL const & model) : _global_m_map(model.global_m_map())
  {
   ...
   */
  global_M_extrapolation_t(tchecker::dbm::global_M_extrapolation_t<EXTRAPOLATION> const & e) : _global_m_map(e._global_m_map)
  {
    _M = _global_m_map.get().M().ptr();
  }
   ...
   */
  template <class VLOC> inline void extrapolate(tchecker::dbm::db_t * dbm, tchecker::clock_id_t dim, VLOC const & vloc)
  {
...
/*!
 ...
 \tparam EXTRAPOLATION : extrapolation function, uses M clock bounds
 */
template <extra_M_t EXTRAPOLATION> class local_M_extrapolation_t {
public:
  /*!
   \brief Constructor
   \param model : a model
   ...
   */
  template <class MODEL> explicit local_M_extrapolation_t(MODEL const & model) : _local_m_map(model.local_m_map())
  {
  ...
  /*!
   ...
   \post this is a copy of e
   */
  local_M_extrapolation_t(tchecker::dbm::local_M_extrapolation_t<EXTRAPOLATION> const & e) : _local_m_map(e._local_m_map)
  {
  ...
  /*!
   ...
   \post e has been moved to this
   */
  local_M_extrapolation_t(tchecker::dbm::local_M_extrapolation_t<EXTRAPOLATION> && e) : _local_m_map(std::move(e._local_m_map))
  {
    _M = e._M;
    e._M = nullptr;
  }
  ...
  /*!
   \brief Destructor
   */
  virtual ~local_M_extrapolation_t() { tchecker::clockbounds::deallocate_map(_M); }
  ...
  /*!
   ...
   \return this after assignment
   */
  tchecker::dbm::local_M_extrapolation_t<EXTRAPOLATION> & operator=(tchecker::dbm::local_M_extrapolation_t<EXTRAPOLATION> && e)
  {
    if (this != &e) {
 ...
 */
template <extra_LU_t EXTRAPOLATION> class global_LU_extrapolation_t {
public:
  /*!
   \brief Constructor
   \param model : a model
   ...
   */
  template <class MODEL> explicit global_LU_extrapolation_t(MODEL const & model) : _global_lu_map(model.global_lu_map())
  {
...
/*!
 ...
 \tparam EXTRAPOLATION : extrapolation function, uses LU clock bounds
 */
template <extra_LU_t EXTRAPOLATION> class local_LU_extrapolation_t {
public:
  /*!
   \brief Constructor
   \param model : a model
   ...
   */
  template <class MODEL> explicit local_LU_extrapolation_t(MODEL const & model) : _local_lu_map(model.local_lu_map())
  {
  ...
  /*!
   ...
   \post this is a copy of e
   */
  local_LU_extrapolation_t(tchecker::dbm::local_LU_extrapolation_t<EXTRAPOLATION> const & e) : _local_lu_map(e._local_lu_map)
  {
...
public:
   ...
   */
  template <class MODEL> explicit no_extrapolation_t(MODEL const & model) {}
