...
public:
   ...
   */
  template <class MODEL> explicit elapsed_semantics_t(MODEL const & model) : EXTRAPOLATION(model) {}
   ...
   */
  tchecker::dbm::elapsed_semantics_t<EXTRAPOLATION> & operator=(tchecker::dbm::elapsed_semantics_t<EXTRAPOLATION> &&) = default;
   ...
   */
  template <class VLOC>
  enum tchecker::state_status_t initialize(tchecker::dbm::zone_t & zone, bool delay_allowed,
  ...
  next(tchecker::dbm::zone_t & zone, bool src_delay_allowed, tchecker::clock_constraint_container_t const & src_invariant,
       tchecker::clock_constraint_container_t const & guard, tchecker::clock_reset_container_t const & clkreset,
       bool tgt_delay_allowed, tchecker::clock_constraint_container_t const & tgt_invariant, VLOC const & tgt_vloc)
  {
    tchecker::dbm::db_t * dbm = zone.dbm();
    auto dim = zone.dim();
...
public:
  ...
  /*!
   ...
   \tparam MODEL : type of model, should inherit from tchecker::clockbounds::model_t
   */
  template <class MODEL> explicit non_elapsed_semantics_t(MODEL const & model) : EXTRAPOLATION(model) {}
