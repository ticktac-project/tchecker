 ...
 */
inline std::size_t hash_value(tchecker::dbm::zone_t const & zone) { return zone.hash(); }
...
/*!
 ...
 tchecker::dbm::zone_t
 */
template <> class allocation_size_t<tchecker::dbm::zone_t> {
public:
  /*!
   \brief Accessor
   \param dim : dimension
 ...
 */
template <class... ARGS> tchecker::dbm::zone_t * zone_allocate_and_construct(tchecker::clock_id_t dim, ARGS &&... args)
{
  if (dim < 1)
