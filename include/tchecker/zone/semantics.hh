...
public:
   ...
   */
  template <class VLOC>
  enum tchecker::state_status_t initialize(/* actual zone type */ &zone, bool delay_allowed,
  ...
  next(/* actual zone type */ &zone, bool src_delay_allowed, tchecker::clock_constraint_container_t const & src_invariant,
