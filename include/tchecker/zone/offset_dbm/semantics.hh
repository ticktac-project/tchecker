 ...
 */
bool constrain(tchecker::dbm::db_t * dbm, tchecker::clock_id_t dim, tchecker::clock_constraint_container_t const & constraints);
...
/*!
 ...
 of x
 */
void reset(tchecker::dbm::db_t * dbm, tchecker::clock_id_t dim, tchecker::clock_id_t refcount,
           tchecker::clock_id_t const * refmap, tchecker::clock_reset_container_t const & resets);
...
public:
  /*!
   ...
   \param refmap : map to reference clocks
   */
  sync_zone_computer_t(tchecker::clock_id_t offset_dim, tchecker::clock_id_t refcount, tchecker::clock_id_t const * refmap);
   ...
   */
  tchecker::offset_dbm::details::sync_zone_computer_t & operator=(tchecker::offset_dbm::details::sync_zone_computer_t const &);

  /*!
   \brief Move-assignment operator
   */
  tchecker::offset_dbm::details::sync_zone_computer_t & operator=(tchecker::offset_dbm::details::sync_zone_computer_t &&);
   ...
   */
  enum tchecker::dbm::status_t sync_zone(tchecker::dbm::db_t const * const offset_dbm, tchecker::clock_id_t offset_dim,
 ...
 */
template <class EXTRAPOLATION> class elapsed_semantics_t : private EXTRAPOLATION {
public:
  /*!
  ...
  explicit elapsed_semantics_t(MODEL const & model)
      : EXTRAPOLATION(model), _offset_dim(model.flattened_offset_clock_variables().size()),
        _refcount(model.flattened_offset_clock_variables().refcount()), _refmap(nullptr), _sync_zone_computer(nullptr)
  {
  ...
  enum tchecker::state_status_t initialize(tchecker::offset_dbm::zone_t & offset_zone,
                                           ...
                                           tchecker::clock_constraint_container_t const & invariant, VLOC const & vloc)
  {
   ...
   */
  template <class VLOC>
  enum tchecker::state_status_t initialize(tchecker::offset_dbm::zone_t & offset_zone, tchecker::dbm::zone_t & sync_zone,
                                           boost::dynamic_bitset<> const & delay_allowed,
                                           tchecker::clock_constraint_container_t const & invariant, VLOC const & vloc)
  {
    ...
    if (_sync_zone_computer->sync_zone(offset_zone.dbm(), offset_zone.dim(), sync_dbm, sync_dim) == tchecker::dbm::EMPTY)
  ...
  next(tchecker::offset_dbm::zone_t & offset_zone, boost::dynamic_bitset<> const & src_delay_allowed,
       tchecker::clock_constraint_container_t const & src_invariant, tchecker::clock_constraint_container_t const & guard,
       tchecker::clock_reset_container_t const & clkreset, boost::dynamic_bitset<> const & tgt_delay_allowed,
       tchecker::clock_constraint_container_t const & tgt_invariant, VLOC const & tgt_vloc)
  {
    ...
    if (tchecker::offset_dbm::details::constrain(offset_dbm, offset_dim, tgt_invariant) == tchecker::dbm::EMPTY)
  ...
  template <class VLOC>
  enum tchecker::state_status_t
  next(tchecker::offset_dbm::zone_t & offset_zone, tchecker::dbm::zone_t & sync_zone,
       ...
       VLOC const & tgt_vloc)
  {
    ...
    enum tchecker::state_status_t status =
        next(offset_zone, src_delay_allowed, src_invariant, guard, clkreset, tgt_delay_allowed, tgt_invariant, tgt_vloc);
...
/*!
 ...
 \tparam EXTRAPOLATION : a zone DBM extrapolation, should implement tchecker::dbm::extrapolation_t
 */
template <class EXTRAPOLATION> class non_elapsed_semantics_t : private EXTRAPOLATION {
public:
  /*!
   \brief Type of offet zones
   */
  ...
  non_elapsed_semantics_t(tchecker::offset_dbm::non_elapsed_semantics_t<EXTRAPOLATION> const & zs)
      : EXTRAPOLATION(zs), _offset_dim(zs._offset_dim), _refcount(zs._refcount), _refmap(nullptr), _sync_zone_computer(nullptr)
  {
    _refmap = new tchecker::clock_id_t[_offset_dim];
    std::memcpy(_refmap, zs._refmap, _offset_dim * sizeof(*_refmap));
    _sync_zone_computer = new tchecker::offset_dbm::details::sync_zone_computer_t(_offset_dim, _refcount, _refmap);
       ...
       tchecker::clock_constraint_container_t const & tgt_invariant, VLOC const & tgt_vloc)
  {
    ...
    if (tchecker::offset_dbm::details::constrain(offset_dbm, offset_dim, src_invariant) == tchecker::dbm::EMPTY)
