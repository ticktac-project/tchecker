 ...
 */
template <class SYSTEM, class VARIABLES> class model_t : public tchecker::clockbounds::model_t<SYSTEM, VARIABLES> {
public:
  /*!
   \brief Copy constructor
   */
  model_t(tchecker::zg::details::model_t<SYSTEM, VARIABLES> const & model)
      : tchecker::clockbounds::model_t<SYSTEM, VARIABLES>(model), _dimension(model._dimension)
  {
  }
  ...
  model_t(tchecker::zg::details::model_t<SYSTEM, VARIABLES> && model)
      : tchecker::clockbounds::model_t<SYSTEM, VARIABLES>(std::move(model)), _dimension(model._dimension)
  {
  }
   ...
   */
  tchecker::zg::details::model_t<SYSTEM, VARIABLES> & operator=(tchecker::zg::details::model_t<SYSTEM, VARIABLES> const & model)
  {
    if (this != &model) {
  ...
  /*!
   ...
   \return this after assignment
   */
  tchecker::zg::details::model_t<SYSTEM, VARIABLES> & operator=(tchecker::zg::details::model_t<SYSTEM, VARIABLES> && model)
  {
    if (this != &model) {
   ...
   */
  virtual inline tchecker::clock_id_t dimension() const { return _dimension; }
