 ...
 */
template <class TA, class ZONE_SEMANTICS> class zg_t {
public:
  /*!
   \brief Type of model
   */
  ...
  /*!
   ...
   \param model : a model
   */
  template <class MODEL> explicit zg_t(MODEL & model) : _ta(model), _zone_semantics(model) {}
  ...
  /*!
   ...
   \return this after assignment
   */
  tchecker::zg::details::zg_t<TA, ZONE_SEMANTICS> & operator=(tchecker::zg::details::zg_t<TA, ZONE_SEMANTICS> && zg) = default;
   ...
   */
  enum tchecker::state_status_t initialize(vloc_t & vloc, intvars_valuation_t & intvars_val, zone_t & zone,
  ...
  next(vloc_t & vloc, intvars_valuation_t & intvars_val, zone_t & zone, outgoing_edges_iterator_value_t const & vedge,
       tchecker::clock_constraint_container_t & src_invariant, tchecker::clock_constraint_container_t & guard,
       tchecker::clock_reset_container_t & clkreset, tchecker::clock_constraint_container_t & tgt_invariant)
  {
    ...
    return _zone_semantics.next(zone, src_delay_allowed, src_invariant, guard, clkreset, tgt_delay_allowed, tgt_invariant,
                                vloc);
  }
