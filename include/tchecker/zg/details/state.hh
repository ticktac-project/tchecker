...
public:
  ...
  state_t(ZONE_PTR const & zone, VLOC_PTR const & vloc, INTVARS_VAL_PTR const & intvars_val)
      : tchecker::ta::details::state_t<VLOC, INTVARS_VAL, VLOC_PTR, INTVARS_VAL_PTR>(vloc, intvars_val), _zone(zone)
  {
  }
  ...
  /*!
   ...
   \note this keeps a pointer to vloc, intvars_val and zone
   */
  state_t(tchecker::zg::details::state_t<VLOC, INTVARS_VAL, ZONE, VLOC_PTR, INTVARS_VAL_PTR, ZONE_PTR> const & s,
          ZONE_PTR const & zone, VLOC_PTR const & vloc, INTVARS_VAL_PTR const & intvars_val)
      : tchecker::ta::details::state_t<VLOC, INTVARS_VAL, VLOC_PTR, INTVARS_VAL_PTR>(s, vloc, intvars_val), _zone(zone)
  {
  }
  ...
  /*!
   ...
   \return zone
   */
  inline ZONE const & zone() const { return *_zone; }

  /*!
   \brief Accessor
   \return pointer to zone
   */
  inline ZONE_PTR & zone_ptr() { return _zone; }
 ...
 */
template <class VLOC, class INTVARS_VAL, class ZONE, class VLOC_PTR, class INTVARS_VAL_PTR, class ZONE_PTR>
int lexical_cmp(tchecker::zg::details::state_t<VLOC, INTVARS_VAL, ZONE, VLOC_PTR, INTVARS_VAL_PTR, ZONE_PTR> const & s1,
                tchecker::zg::details::state_t<VLOC, INTVARS_VAL, ZONE, VLOC_PTR, INTVARS_VAL_PTR, ZONE_PTR> const & s2)
{
