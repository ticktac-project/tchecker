 ...
 */
template <class ZONE_SEMANTICS> using zg_t = tchecker::zg::details::zg_t<tchecker::zg::ta::ta_t, ZONE_SEMANTICS>;
 ...
 */
template <class ZONE>
using state_t = tchecker::zg::details::state_t<tchecker::zg::ta::shared_vloc_t, tchecker::zg::ta::shared_intvars_valuation_t,
...
/*!
 ...
 \tparam ZONE : type of zone
 */
template <class ZONE> using shared_state_t = tchecker::make_shared_t<tchecker::zg::ta::state_t<ZONE>>;
 ...
 */
template <class STATE> class state_pool_allocator_t : public tchecker::zg::details::state_pool_allocator_t<STATE> {
public:
  /*!
   \brief Constructor
   \param model : a model
  ...
  state_pool_allocator_t(tchecker::zg::ta::model_t & model, std::size_t alloc_nb)
      : tchecker::zg::details::state_pool_allocator_t<STATE>(alloc_nb, alloc_nb, model.system().processes_count(), alloc_nb,
                                                             model.flattened_integer_variables().flattened_size(), alloc_nb,
                                                             model.flattened_clock_variables().flattened_size())
  {
  }
};
...
using ts_t = tchecker::zg::details::ts_t<tchecker::zg::ta::state_t<typename ZONE_SEMANTICS::zone_t>,
                                         tchecker::zg::ta::transition_t, tchecker::zg::ta::zg_t<ZONE_SEMANTICS>>;
...
public:
   ...
   */
  template <class STATE = shared_state_t> using state_pool_allocator_t = tchecker::zg::ta::state_pool_allocator_t<STATE>;
 ...
 */
template <class ZONE> class allocation_size_t<tchecker::zg::ta::state_t<ZONE>> {
public:
  static constexpr std::size_t alloc_size() { return sizeof(tchecker::zg::ta::state_t<ZONE>); }
};
