...
namespace tchecker {
  ...
  namespace syncprod {
    ...
    public:
       ...
       */
      constexpr inline tchecker::vedge_t const & vedge() const
      {
        return *_vedge;
      }
       ...
       */
      inline tchecker::intrusive_shared_ptr_t<tchecker::shared_vedge_t> vedge_ptr()
      {
        return _vedge;
      }
    ...
    /*!
     ...
     \return 0 if t1 and t2 are equal, a negative value if t1 is smaller than t2 w.r.t. lexical ordering on tuple of edges, a positive value otherwise
     */
   ...
   */
  template <>
  class allocation_size_t<tchecker::syncprod::transition_t> {
  public:
    /*!
