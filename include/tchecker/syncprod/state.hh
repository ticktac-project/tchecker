...
namespace tchecker {
  ...
  namespace syncprod {
    ...
    public:
       ...
       */
      state_t(tchecker::syncprod::state_t const & s,
       ...
       */
      state_t(tchecker::syncprod::state_t &&) = delete;
       ...
       */
      tchecker::syncprod::state_t & operator= (tchecker::syncprod::state_t const &) = default;
       ...
       */
      constexpr inline tchecker::vloc_t const & vloc() const
      {
        return *_vloc;
      }
       ...
       */
      inline tchecker::intrusive_shared_ptr_t<tchecker::shared_vloc_t> vloc_ptr()
      {
        return _vloc;
      }
    ...
    /*!
     ...
     \param s1 : a state
     \param s2 : a state
     \return 0 if s1 and s2 are equal, a negative value if s1 is smaller than s2 w.r.t. lexical ordering on tuple of locations, a positive value otherwise
     */
   ...
   */
  template <>
  class allocation_size_t<tchecker::syncprod::state_t> {
  public:
    /*!
