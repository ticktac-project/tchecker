  ...
  namespace syncprod {
    ...
    namespace details {
      ...
      /*!
       ...
       \brief Pool allocator for states of synchronized product of transition systems that can be extended to allocate more complex states
       */
      template <class STATE>
      class state_pool_allocator_t : private tchecker::ts::state_pool_allocator_t<STATE> {
      ...
      public:
        ...
        _vloc_pool(vloc_alloc_nb,
                   tchecker::allocation_size_t<tchecker::shared_vloc_t>::alloc_size(_vloc_capacity))
        {}
        ...
        {
          return
          tchecker::ts::state_pool_allocator_t<STATE>::construct_from_state
          (state, args..., _vloc_pool.construct(state.vloc()));
        }
        ...
        {
          return tchecker::ts::state_pool_allocator_t<STATE>::memsize() + _vloc_pool.memsize();
        }
      ...
      /*!
       ...
       \tparam TRANSITION : type of transitions, should inherit from tchecker::syncprod::transition_t and should be a tchecker::make_shared object
       \brief Pool allocator for transitions of synchronized product of transition systems that can be extended to allocate more complex transitions
       */
      template <class TRANSITION>
      class transition_pool_allocator_t : private tchecker::ts::transition_pool_allocator_t<TRANSITION> {
      ...
      public:
         ...
         */
        transition_pool_allocator_t(std::size_t transition_alloc_nb,
                                    std::size_t vedge_alloc_nb,
                                    std::size_t vedge_capacity)
        : tchecker::ts::transition_pool_allocator_t<TRANSITION>(transition_alloc_nb),
        _vedge_capacity(vedge_capacity),
        _vedge_pool(vedge_alloc_nb,
                    tchecker::allocation_size_t<tchecker::shared_vedge_t>::alloc_size(_vedge_capacity))
        {}
        
        /*!
         \brief Copy constructor (deleted)
         */
        transition_pool_allocator_t(tchecker::syncprod::details::transition_pool_allocator_t<TRANSITION> const &)
        = delete;
        
        /*!
         \brief Move constructor (deleted)
         */
        transition_pool_allocator_t(tchecker::syncprod::details::transition_pool_allocator_t<TRANSITION> &&)
        = delete;
        ...
        {
          return tchecker::ts::transition_pool_allocator_t<TRANSITION>::construct
          (args..., _vedge_pool.construct(_vedge_capacity));
        }
        ...
        {
          return
          tchecker::ts::transition_pool_allocator_t<TRANSITION>::construct_from_transition
    ...
    public:
      using
      tchecker::syncprod::details::state_pool_allocator_t<tchecker::syncprod::shared_state_t>
      ::state_pool_allocator_t;
    };
    ...
    public:
      using
      tchecker::syncprod::details::transition_pool_allocator_t<tchecker::syncprod::shared_transition_t>
      ::transition_pool_allocator_t;
    };
