...
namespace tchecker {
   ...
   */
  using edge_array_t = tchecker::make_array_t<tchecker::edge_id_t, sizeof(tchecker::edge_id_t),
  tchecker::array_capacity_t<unsigned int>>;
  ...
  public:
     ...
     */
    inline tchecker::edge_array_t::capacity_t size() const
    {
      return tchecker::edge_array_t::capacity();
    }
     ...
     */
    using iterator_t
    = boost::filter_iterator<std::function<bool(tchecker::edge_id_t)>, tchecker::edge_array_t::iterator_t>;
   ...
   */
  template <>
  class allocation_size_t<tchecker::vedge_t> {
  public:
    /*!
   ...
   */
  template <class... ARGS>
  tchecker::vedge_t * vedge_allocate_and_construct(unsigned int size, ARGS && ... args)
  {
  ...
  /*!
   ...
   \return 0 if vedge1 and vedge2 are equal, a negative value if vedge1 is smaller than vedge2 w.r.t. lexical ordering, and a positive value otherwise
   */
