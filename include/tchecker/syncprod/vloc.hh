...
namespace tchecker {
   ...
   */
  using loc_array_t = tchecker::make_array_t<tchecker::loc_id_t, sizeof(tchecker::loc_id_t),
  ...
  public:
     ...
     */
    inline tchecker::loc_array_t::capacity_t size() const
    {
      return tchecker::loc_array_t::capacity();
    }
   ...
   */
  template <>
  class allocation_size_t<tchecker::vloc_t> {
  public:
    /*!
   ...
   */
  template <class... ARGS>
  tchecker::vloc_t * vloc_allocate_and_construct(unsigned int size, ARGS && ... args)
  {
