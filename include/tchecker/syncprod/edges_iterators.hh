...
/*!
 ...
 \brief Iterators on collection of edges to abstract synchonized and asynchronous edges
 */
...
namespace tchecker {
  ...
  namespace syncprod {
    ...
    boost::transform_iterator<tchecker::syncprod::loc_to_asynchronous_edges_map_t,
    tchecker::vloc_t::const_iterator_t>;
    ...
    public:
      /*!
       ...
       \note this iterator keeps a reference on loc_edges_maps
       */
       ...
       */
      vloc_synchronized_edges_iterator_t(tchecker::syncprod::vloc_synchronized_edges_iterator_t const &)
      = default;
    ...
    protected:
      ...
      std::reference_wrapper<tchecker::system::loc_edges_maps_t const> _loc_edges_maps;
    ...
    public:
      ...
      /*!
       \brief Assignment operator
       */
      tchecker::syncprod::edges_iterator_t &
      operator= (tchecker::syncprod::edges_iterator_t const & it) = default;
      
      /*!
       \brief Move-assignment operator
       */
      tchecker::syncprod::edges_iterator_t &
      operator= (tchecker::syncprod::edges_iterator_t && it) = default;
    ...
    public:
      ...
      /*!
       \brief Assignment operator
       */
      tchecker::syncprod::vloc_edges_iterator_t &
      operator= (tchecker::syncprod::vloc_edges_iterator_t const &) = default;
      
      /*!
       \brief Move assignment operator
       */
      tchecker::syncprod::vloc_edges_iterator_t &
      operator= (tchecker::syncprod::vloc_edges_iterator_t &&) = default;
 ...
 */
template <>
struct std::iterator_traits<tchecker::syncprod::edges_iterator_t> {
 ...
 */
template <>
struct std::iterator_traits<tchecker::syncprod::vloc_edges_iterator_t> {
  using difference_type = nullptr_t;
