 ...
 */
template <class NODE_ALLOCATOR, class EDGE_ALLOCATOR> class graph_allocator_t {
public:
  /*!
   \brief Type of nodes
   */
  ...
  graph_allocator_t(tchecker::gc_t & gc, std::tuple<NA_ARGS...> && na_args, std::tuple<EA_ARGS...> && ea_args)
  ...
  graph_allocator_t(std::tuple<tchecker::gc_t &, std::tuple<NA_ARGS...>, std::tuple<EA_ARGS...>> && args)
      : graph_allocator_t(std::get<0>(args), std::forward<std::tuple<NA_ARGS...>>(std::get<1>(args)),
   ...
   */
  template <class... NARGS> inline node_ptr_t allocate_node(NARGS &&... nargs) { return _allocator_node(nargs...); }
  ...
  /*!
   ...
   \return pointer to a newly allocated node constructed from nargs
   */
  template <class... NARGS> inline node_ptr_t allocate_node(std::tuple<NARGS...> && nargs)
  {
   ...
   */
  template <class... NARGS> inline node_ptr_t allocate_from_node(node_ptr_t const & node, NARGS &&... nargs)
  {
  ...
  /*!
   ...
   from cloning node, while the node part is built from nargs
   */
  template <class... NARGS> inline node_ptr_t allocate_from_node(node_ptr_t const & node, std::tuple<NARGS...> && nargs)
  {
   ...
   */
  template <class... EARGS> inline edge_ptr_t allocate_edge(EARGS &&... eargs) { return _allocate_edge(eargs...); }
  ...
  /*!
   ...
   \return pointer to a newly allocated edge constructed from eargs
   */
  template <class... EARGS> inline edge_ptr_t allocate_edge(std::tuple<EARGS...> && eargs)
  {
...
protected:
  /*!
   ...
   \return pointer to a newly allocated node constructed from nargs
   */
  template <class... NARGS> inline node_ptr_t _allocate_node(NARGS &&... nargs) { return _node_allocator.construct(nargs...); }
  ...
  /*!
   ...
   from cloning node, while the node part is built from nargs
   */
  template <class... NARGS> inline node_ptr_t _allocate_from_node(node_ptr_t const & node, NARGS &&... nargs)
  {
  ...
  /*!
   ...
   \return pointer to a newly allocated edge constructed from eargs
   */
  template <class... EARGS> inline edge_ptr_t _allocate_edge(EARGS &&... eargs) { return _edge_allocator.construct(eargs...); }
