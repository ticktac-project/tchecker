...
public:
  ...
  /*!
   ...
   \return true
   */
  bool add_node(NODE_PTR const & node) { return true; }
  ...
  /*!
   ...
   \return true
   */
  bool remove_node(NODE_PTR const & node) { return true; }
  ...
  /*!
   ...
   \return true
   */
  bool add_edge(NODE_PTR const & src, NODE_PTR const & tgt, EDGE_PTR const & edge) { return true; }
};
