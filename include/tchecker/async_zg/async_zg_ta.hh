 ...
 */
template <class ZONE_SEMANTICS> using zg_t = tchecker::async_zg::details::zg_t<tchecker::async_zg::ta::ta_t, ZONE_SEMANTICS>;
 ...
 */
template <class ZONE> using shared_zone_t = tchecker::make_shared_t<ZONE>;
...
using state_t = tchecker::async_zg::details::state_t<
    tchecker::async_zg::ta::shared_vloc_t, tchecker::async_zg::ta::shared_intvars_valuation_t,
    tchecker::async_zg::ta::shared_zone_t<OFFSET_ZONE>, tchecker::async_zg::ta::shared_zone_t<SYNC_ZONE>,
 ...
 */
template <class STATE> class state_pool_allocator_t : public tchecker::async_zg::details::state_pool_allocator_t<STATE> {
public:
  /*!
   \brief Constructor
   \param model : a model
  ...
  state_pool_allocator_t(tchecker::async_zg::ta::model_t & model, std::size_t alloc_nb)
      : tchecker::async_zg::details::state_pool_allocator_t<STATE>(
            alloc_nb, alloc_nb, model.system().processes_count(), alloc_nb,
            model.flattened_integer_variables().flattened_size(), alloc_nb,
            model.flattened_offset_clock_variables().flattened_size(), model.flattened_clock_variables().flattened_size())
  {
  }
};
...
using ts_t = tchecker::async_zg::details::ts_t<
    tchecker::async_zg::ta::state_t<typename ZONE_SEMANTICS::offset_zone_t, typename ZONE_SEMANTICS::sync_zone_t>,
    tchecker::async_zg::ta::transition_t, tchecker::async_zg::ta::zg_t<ZONE_SEMANTICS>>;
 ...
 */
template <class ZONE_SEMANTICS> class instance_types_t {
public:
  /*!
  ...
  /*!
   \brief Type of state
   */
  using state_t = tchecker::async_zg::ta::state_t<typename ZONE_SEMANTICS::offset_zone_t, typename ZONE_SEMANTICS::sync_zone_t>;
   ...
   */
  template <class STATE = shared_state_t> using state_pool_allocator_t = tchecker::async_zg::ta::state_pool_allocator_t<STATE>;
 ...
 */
template <class OFFSET_ZONE, class SYNC_ZONE> class allocation_size_t<tchecker::async_zg::ta::state_t<OFFSET_ZONE, SYNC_ZONE>> {
public:
  static constexpr std::size_t alloc_size() { return sizeof(tchecker::async_zg::ta::state_t<OFFSET_ZONE, SYNC_ZONE>); }
};
