 ...
 */
template <class TA, class ASYNC_ZONE_SEMANTICS> class zg_t {
public:
  /*!
   \brief Type of model
   */
  ...
  explicit zg_t(ASYNC_MODEL & model)
      : _ta(model), _async_zone_semantics(model), _refcount(model.flattened_offset_clock_variables().refcount()),
        _refmap(model.flattened_offset_clock_variables().refmap()), _src_delay_allowed(model.system().processes_count()),
   ...
   */
  inline tchecker::range_t<initial_iterator_t> initial() const { return _ta.initial(); }
   ...
   */
  enum tchecker::state_status_t initialize(vloc_t & vloc, intvars_valuation_t & intvars_val, offset_zone_t & offset_zone,
                                           ...
                                           tchecker::clock_constraint_container_t & invariant)
  {
    ...
    return _async_zone_semantics.initialize(offset_zone, _src_delay_allowed, _offset_src_invariant, vloc);
  }
   ...
   */
  enum tchecker::state_status_t initialize(vloc_t & vloc, intvars_valuation_t & intvars_val, offset_zone_t & offset_zone,
                                           sync_zone_t & sync_zone, initial_iterator_value_t const & initial_range,
                                           tchecker::clock_constraint_container_t & invariant)
  {
    auto status = _ta.initialize(vloc, intvars_val, initial_range, invariant);
    if (status != tchecker::STATE_OK)
    ...
    translate_invariant(invariant);
    tchecker::ta::delay_allowed(vloc, _src_delay_allowed);
    return _async_zone_semantics.initialize(offset_zone, sync_zone, _src_delay_allowed, _offset_src_invariant, vloc);
  }
   ...
   */
  enum tchecker::state_status_t next(vloc_t & vloc, intvars_valuation_t & intvars_val, offset_zone_t & offset_zone,
                                     ...
                                     tchecker::clock_constraint_container_t & tgt_invariant)
  {
    ...
    return _async_zone_semantics.next(offset_zone, _src_delay_allowed, _offset_src_invariant, _offset_guard, _offset_clkreset,
                                      _tgt_delay_allowed, _offset_tgt_invariant, vloc);
  }
   ...
   */
  enum tchecker::state_status_t next(vloc_t & vloc, intvars_valuation_t & intvars_val, offset_zone_t & offset_zone,
                                     sync_zone_t & sync_zone, outgoing_edges_iterator_value_t const & vedge,
                                     tchecker::clock_constraint_container_t & src_invariant,
                                     tchecker::clock_constraint_container_t & guard,
                                     tchecker::clock_reset_container_t & clkreset,
                                     tchecker::clock_constraint_container_t & tgt_invariant)
  {
    ...
    translate_guard_reset_invariants(src_invariant, guard, clkreset, tgt_invariant);
    reference_clock_synchronization(vedge, _offset_guard);
    return _async_zone_semantics.next(offset_zone, sync_zone, _src_delay_allowed, _offset_src_invariant, _offset_guard,
                                      _offset_clkreset, _tgt_delay_allowed, _offset_tgt_invariant, vloc);
  }
   ...
   */
  inline constexpr model_t const & model() const { return _ta.model(); }
...
private:
                 ...
                 tchecker::clock_constraint_container_t & offset_constraints)
  {
    ...
    for (auto & c : constraints) {
      if ((c.id1() == tchecker::REFCLOCK_ID) && (c.id2() == tchecker::REFCLOCK_ID))
        throw std::invalid_argument("cannot translate clock constraint of the form 0-0 <= c");
      offset_id1 = (c.id1() == tchecker::REFCLOCK_ID ? tchecker::offset_dbm::reference_id(c.id2(), _refcount, _refmap)
                                                     : tchecker::offset_dbm::offset_id(c.id1(), _refcount));
      offset_id2 = (c.id2() == tchecker::REFCLOCK_ID ? tchecker::offset_dbm::reference_id(c.id1(), _refcount, _refmap)
