...
public:
  ...
  model_t(tchecker::async_zg::details::model_t<SYSTEM, VARIABLES> const & model)
      : tchecker::clockbounds::model_t<SYSTEM, VARIABLES>(model), _flattened_offset_clocks(model._flattened_offset_clocks)
  {
  }
...
protected:
   ...
   */
  explicit model_t(SYSTEM * system, tchecker::log_t & log) : tchecker::clockbounds::model_t<SYSTEM, VARIABLES>(system, log)
  {
    ...
    _flattened_offset_clocks = tchecker::build_from_variable_access(
        vaccess_map, system->processes_count(), tchecker::clockbounds::model_t<SYSTEM, VARIABLES>::flattened_clock_variables());
  }
