...
inline std::ostream & output(std::ostream & os,
                             ...
                             tchecker::intvar_index_t const & intvar_index, tchecker::clock_index_t const & offset_clock_index,
...
public:
   ...
   */
  state_outputter_t(tchecker::intvar_index_t const & intvar_index, tchecker::clock_index_t const & offset_clock_index,
                    tchecker::clock_index_t const & sync_clock_index)
      : tchecker::ta::details::state_outputter_t(intvar_index), _offset_clock_index(offset_clock_index),
   ...
   */
  tchecker::async_zg::details::state_outputter_t & operator=(tchecker::async_zg::details::state_outputter_t const &) = delete;
  ...
  inline std::ostream & output(std::ostream & os,
                               tchecker::async_zg::details::state_t<VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE, VLOC_PTR,
                                                                    INTVARS_VAL_PTR, OFFSET_ZONE_PTR, SYNC_ZONE_PTR> const & s)
  {
    return tchecker::async_zg::details::output(os, s, _intvar_index, _offset_clock_index, _sync_clock_index);
  }
