 ...
 */
template <class VLOC, class INTVARS_VAL, class OFFSET_ZONE, class SYNC_ZONE, class VLOC_PTR, class INTVARS_VAL_PTR,
          class OFFSET_ZONE_PTR, class SYNC_ZONE_PTR>
class state_t : public tchecker::ta::details::state_t<VLOC, INTVARS_VAL, VLOC_PTR, INTVARS_VAL_PTR> {
  using this_state_t = tchecker::async_zg::details::state_t<VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE, VLOC_PTR,
                                                            INTVARS_VAL_PTR, OFFSET_ZONE_PTR, SYNC_ZONE_PTR>;
...
public:
   ...
   */
  state_t(OFFSET_ZONE_PTR const & offset_zone, SYNC_ZONE_PTR const & sync_zone, VLOC_PTR const & vloc,
          INTVARS_VAL_PTR const & intvars_val)
      : tchecker::ta::details::state_t<VLOC, INTVARS_VAL, VLOC_PTR, INTVARS_VAL_PTR>(vloc, intvars_val),
        _offset_zone(offset_zone), _sync_zone(sync_zone)
  {
  }
  ...
  /*!
   ...
   \note this keeps a pointer to vloc, intvars_val, offset_zone and sync_zone
   */
  state_t(this_state_t const & s, OFFSET_ZONE_PTR const & offset_zone, SYNC_ZONE_PTR const & sync_zone, VLOC_PTR const & vloc,
          INTVARS_VAL_PTR const & intvars_val)
  ...
  /*!
   ...
   \return offset zone
   */
  inline OFFSET_ZONE const & offset_zone() const { return *_offset_zone; }

  /*!
   \brief Accessor
   \return pointer to offset zone
   */
  inline OFFSET_ZONE_PTR & offset_zone_ptr() { return _offset_zone; }

  /*!
   \brief Accessor
   \return synchronized zone
   */
  inline SYNC_ZONE const & sync_zone() const { return *_sync_zone; }

  /*!
   \brief Accessor
   \return pointer to synchronized zone
   */
  inline SYNC_ZONE_PTR & sync_zone_ptr() { return _sync_zone; }
...
template <class VLOC, class INTVARS_VAL, class OFFSET_ZONE, class SYNC_ZONE, class VLOC_PTR, class INTVARS_VAL_PTR,
          class OFFSET_ZONE_PTR, class SYNC_ZONE_PTR>
inline bool operator==(tchecker::async_zg::details::state_t<VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE, VLOC_PTR,
                                                            INTVARS_VAL_PTR, OFFSET_ZONE_PTR, SYNC_ZONE_PTR> const & s1,
                       tchecker::async_zg::details::state_t<VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE, VLOC_PTR,
                                                            INTVARS_VAL_PTR, OFFSET_ZONE_PTR, SYNC_ZONE_PTR> const & s2)
{
  return (tchecker::ta::operator==(s1, s2) && (s1.offset_zone() == s2.offset_zone()) && (s1.sync_zone() == s2.sync_zone()));
}
...
template <class VLOC, class INTVARS_VAL, class OFFSET_ZONE, class SYNC_ZONE, class VLOC_PTR, class INTVARS_VAL_PTR,
          class OFFSET_ZONE_PTR, class SYNC_ZONE_PTR>
inline std::size_t hash_value(tchecker::async_zg::details::state_t<VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE, VLOC_PTR,
                                                                   INTVARS_VAL_PTR, OFFSET_ZONE_PTR, SYNC_ZONE_PTR> const & s)
{
...
/*!
 ...
 \return 0 if s1 and s2 are equal, a negative value if s1 is smaller than s2 w.r.t. lexical ordering on tuple of locations, then
 intger valuation, then zone, a positive value otherwise
 */
template <class VLOC, class INTVARS_VAL, class OFFSET_ZONE, class SYNC_ZONE, class VLOC_PTR, class INTVARS_VAL_PTR,
          class OFFSET_ZONE_PTR, class SYNC_ZONE_PTR>
int lexical_cmp(tchecker::async_zg::details::state_t<VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE, VLOC_PTR, INTVARS_VAL_PTR,
                                                     OFFSET_ZONE_PTR, SYNC_ZONE_PTR> const & s1,
                tchecker::async_zg::details::state_t<VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE, VLOC_PTR, INTVARS_VAL_PTR,
                                                     OFFSET_ZONE_PTR, SYNC_ZONE_PTR> const & s2)
{
