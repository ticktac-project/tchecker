...
template <class STATE, class VLOC = typename STATE::vloc_t, class INTVARS_VAL = typename STATE::intvars_valuation_t,
          class OFFSET_ZONE = typename STATE::offset_zone_t, class SYNC_ZONE = typename STATE::sync_zone_t>
...
public:
  ...
  state_pool_allocator_t(std::size_t state_alloc_nb, std::size_t vloc_alloc_nb, std::size_t vloc_capacity,
                         std::size_t intvars_val_alloc_nb, std::size_t intvars_val_capacity, std::size_t zone_alloc_nb,
                         tchecker::clock_id_t offset_zone_dimension, tchecker::clock_id_t sync_zone_dimension)
      : tchecker::ta::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL>(state_alloc_nb, vloc_alloc_nb, vloc_capacity,
  ...
  state_pool_allocator_t(
      tchecker::async_zg::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE> const &) = delete;

  /*!
   \brief Move constructor (deleted)
   */
  state_pool_allocator_t(
      tchecker::async_zg::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE> &&) = delete;
   ...
   */
  tchecker::async_zg::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE> & operator=(
      tchecker::async_zg::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE> const &) = delete;
  ...
  operator=(tchecker::async_zg::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL, OFFSET_ZONE, SYNC_ZONE> &&) = delete;
  ...
  {
    return tchecker::ta::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL>::memsize() + _offset_zone_pool.memsize() +
