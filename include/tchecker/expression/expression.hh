...
namespace tchecker {
  ...
  public:
    ...
    /*!
     ...
     \return Offset
     */
    inline tchecker::expression_t const & offset() const
    {
      return (* _offset);
    }
  protected:
  ...
  public:
    ...
    /*!
     ...
     \return Operand
     */
    inline enum unary_operator_t unary_operator() const
    {
      return _operator;
    }
    ...
    /*!
     ...
     \return Operand
     */
    inline tchecker::expression_t const & operand() const
    {
      return (* _expr);
    }
  protected:
  ...
  public:
    ...
    /*!
     ...
     \return Operator
     */
    enum binary_operator_t binary_operator() const
    {
      return _op;
    }
    ...
    /*!
     ...
     \return Left operand
     */
    inline tchecker::expression_t const & left_operand() const
    {
      return (* _left);
    }
     ...
     */
    inline tchecker::expression_t const & right_operand() const
    {
      return (* _right);
    }
  protected:
