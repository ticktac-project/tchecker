...
namespace tchecker {
  ...
  namespace ta {
    ...
    public:
       ...
       */
      state_t(tchecker::ta::state_t const & s,
       ...
       */
      state_t(tchecker::ta::state_t &&) = delete;
       ...
       */
      tchecker::ta::state_t & operator= (tchecker::ta::state_t const &) = default;
       ...
       */
      constexpr inline tchecker::intvars_valuation_t const & intval() const
      {
        return *_intval;
      }
       ...
       */
      inline tchecker::intrusive_shared_ptr_t<tchecker::shared_intval_t> intval_ptr()
      {
        return _intval;
      }
    ...
    /*!
     ...
     \param s1 : state
     \param s2 : state
     \return true if s1 and s2 have different tuples of locations or different valuations of bounded integer variables, false otherwise
     */
    bool operator!= (tchecker::ta::state_t const & s1, tchecker::ta::state_t const & s2);
    ...
    /*!
     ...
     \param s1 : a state
     \param s2 : a state
     \return 0 if s1 and s2 are equal, a negative value if s1 is smaller than s2 w.r.t. lexical ordering on tuple of locations and valuatin
     of bounded integer variables, a positive value otherwise
     */
