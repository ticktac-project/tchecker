...
namespace tchecker {
  ...
  namespace ta {
    ...
    public:
       ...
       */
      using labels_const_iterator_t
      = std::unordered_multimap<tchecker::loc_id_t, tchecker::label_id_t>::const_iterator;
       ...
       */
      constexpr inline tchecker::syncprod::system_t const & as_syncprod_system() const
      {
        return *this;
      }
    private:
       ...
       */
      void set_labels(tchecker::loc_id_t id,
       ...
       */
      void set_committed(tchecker::loc_id_t id,
       ...
       */
      void set_urgent(tchecker::loc_id_t id,
                      tchecker::range_t<tchecker::system::attributes_t::const_iterator_t> const & flags);
       ...
       */
      void set_guards(tchecker::edge_id_t id,
