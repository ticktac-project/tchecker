...
namespace tchecker {
  ...
  namespace ta {
    ...
    public:
      ...
      /*!
       ...
       \return this transition's source invariant container
       */
      inline tchecker::clock_constraint_container_t const & src_invariant_container() const
      {
        return _src_invariant;
      }
      ...
      /*!
       ...
       \return this transition's guard container
       */
      inline tchecker::clock_constraint_container_t const & guard_container() const
      {
        return _guard;
      }
      ...
      /*!
       ...
       \return this transition's reset container
       */
      inline tchecker::clock_reset_container_t const & reset_container() const
      {
        return _reset;
      }
      ...
      /*!
       ...
       \return this transition's target invariant container
       */
      inline tchecker::clock_constraint_container_t const & tgt_invariant_container() const
      {
        return _tgt_invariant;
      }
    ...
    /*!
     ...
     \param t1 : transition
     \param t2 : transition
     \return true if t1 and t2 have different tuples of edges or differene source invariants, or different guard or difference resets or different
     taget invariant, false otherwise
     */
    inline bool operator!= (tchecker::ta::transition_t const & t1, tchecker::ta::transition_t const & t2)
    {
      return !(t1 == t2);
    }
    ...
    /*!
     ...
     \return 0 if t1 and t2 are equal, a negative value if t1 is smaller than t2 w.r.t. lexical ordering on tuple of edges, source invariant, guard, reset,
   ...
   */
  template <>
  class allocation_size_t<tchecker::ta::transition_t> {
  public:
    /*!
