...
namespace tchecker {
  ...
  namespace system {
    ...
    public:
       ...
       */
      void add_intvar(std::string const & name,
                      tchecker::intvar_id_t size = 1,
      ...
      /*!
       \brief Accessor
       \return number of bounded integer variables
       */
      inline tchecker::intvar_id_t intvars_count() const
      {
        return _integer_variables.size();
      }
       ...
       */
      inline tchecker::intvar_id_t intvar_id(std::string const & name) const
      {
        return _integer_variables.id(name);
      }
       ...
       */
      inline std::string const & intvar_name(tchecker::intvar_id_t id) const
      {
        return _integer_variables.name(id);
      }
       ...
       */
      inline tchecker::integer_variables_t const & integer_variables() const
      {
        return _integer_variables;
      }
    private:
