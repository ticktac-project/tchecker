...
namespace tchecker {
  ...
  namespace system {
    ...
    public:
       ...
       */
      sync_constraint_t(tchecker::process_id_t pid,
      ...
      /*!
       ...
       \post this is a copy of sync
       */
      tchecker::system::sync_constraint_t &
      operator= (tchecker::system::sync_constraint_t const & sync) = default;
       ...
       */
      tchecker::system::sync_constraint_t &
      operator= (tchecker::system::sync_constraint_t && sync) = default;
    ...
    public:
       ...
       */
      synchronization_t(tchecker::sync_id_t id,
                        std::vector<tchecker::system::sync_constraint_t> const & v,
      ...
      /*!
       \brief Assignment operator
       */
      tchecker::system::synchronization_t &
      operator= (tchecker::system::synchronization_t const &) = default;
      
      /*!
       \brief Move assignment operator
       */
      tchecker::system::synchronization_t &
      operator= (tchecker::system::synchronization_t &&) = default;
       ...
       */
      inline tchecker::range_t<tchecker::system::synchronization_t::const_iterator_t>
      synchronization_constraints() const
      {
