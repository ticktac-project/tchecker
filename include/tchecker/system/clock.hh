  ...
  namespace system {
    ...
    public:
      ...
      void add_clock(std::string const & name,
                     tchecker::clock_id_t size = 1,
                     tchecker::system::attributes_t const & attr = tchecker::system::attributes_t());
      
      /*!
       \brief Accessor
       \return number of clock variables
       */
      inline tchecker::clock_id_t clocks_count() const
      {
        return _clock_variables.size();
      }
       ...
       */
      inline tchecker::clock_id_t clock_id(std::string const & name) const
      {
        return _clock_variables.id(name);
      }
       ...
       */
      inline std::string const & clock_name(tchecker::clock_id_t id) const
      {
        return _clock_variables.name(id);
      }
       ...
       */
      inline tchecker::clock_variables_t const & clock_variables() const
      {
        return _clock_variables;
      }
    private:
