...
namespace tchecker {
  ...
  namespace system {
    ...
    public:
       ...
       */
      tchecker::system::process_events_map_t &
      operator= (tchecker::system::process_events_map_t const &) = default;
      
      /*!
       \brief Move-assignment operator
       */
      tchecker::system::process_events_map_t &
      operator= (tchecker::system::process_events_map_t &&) = default;
     ...
     */
    tchecker::system::process_events_map_t
    weakly_synchronized_events(tchecker::system::system_t const & system);
