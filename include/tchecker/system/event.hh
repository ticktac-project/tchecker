...
namespace tchecker {
  ...
  namespace system {
    ...
    public:
       ...
       */
      inline tchecker::event_id_t event_id(std::string const & name) const
      {
        return _events_index.value(name);
      }
       ...
       */
      inline std::string const & event_name(tchecker::event_id_t id) const
      {
        return _events_index.key(id);
      }
