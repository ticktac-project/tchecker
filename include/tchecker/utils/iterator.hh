 ...
 */
template <class I> class range_t {
public:
  /*!
   ...
   */
  range_t(I const & begin, I const & end) : _begin(begin), _end(end) {}
   ...
   */
  inline constexpr I const & begin() const { return _begin; }

  /*!
   \brief Accessor
   \return past-the-end iterator
   */
  inline constexpr I const & end() const { return _end; }

  /*!
   \brief Makes a tuple of iterators from a range
   \return tuple of iterators (begin,end) corresponding to this range
   */
  inline std::tuple<I, I> iterators() const { return std::make_tuple(_begin, _end); }
   ...
   */
  inline constexpr bool operator!=(tchecker::range_t<I> const & range) const { return (!(*this == range)); }
 ...
 */
template <class I> tchecker::range_t<I> make_range(I const & begin, I const & end) { return tchecker::range_t<I>(begin, end); }
 ...
 */
template <class I, class II = typename I::value_type::iterator_t> class join_iterator_t {
public:
  /*!
   \brief Type of iterator
   */
   ...
   */
  join_iterator_t() : _get_sub_range([](I const & it) { return std::make_tuple(II{}, II{}); }) {}
  ...
  /*!
   ...
   \return this after assignment
   */
  tchecker::join_iterator_t<I, II> & operator=(tchecker::join_iterator_t<I, II> const & it) = default;
  ...
  /*!
   ...
   \return this after assignment
   */
  tchecker::join_iterator_t<I, II> & operator=(tchecker::join_iterator_t<I, II> && it) = default;
   ...
   */
  inline bool operator!=(tchecker::join_iterator_t<I, II> const & it) const { return (!(*this == it)); }
 ...
 */
template <class I, class II> struct std::iterator_traits<tchecker::join_iterator_t<I, II>> {
 ...
 */
template <class I> class cartesian_iterator_t {
public:
  /*!
   \brief Constructor
   ...
   */
  bool operator!=(tchecker::cartesian_iterator_t<I> const & it) const { return (!(it == *this)); }
 ...
 */
template <class I> struct std::iterator_traits<tchecker::cartesian_iterator_t<I>> {
