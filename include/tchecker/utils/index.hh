...
namespace tchecker {
  ...
  public:
     ...
     */
    inline const_key_map_iterator_t begin_key_map() const
    {
      return const_key_map_iterator_t(_key_map.begin());
    }
     ...
     */
    inline const_key_map_iterator_t end_key_map() const
    {
      return const_key_map_iterator_t(_key_map.end());
    }
     ...
     */
    inline const_value_map_iterator_t begin_value_map() const
    {
      return const_value_map_iterator_t(_value_map.begin());
    }
     ...
     */
    inline const_value_map_iterator_t end_value_map() const
    {
      return const_value_map_iterator_t(_value_map.end());
    }
     ...
     */
    inline const_key_map_iterator_t begin() const
    {
      return begin_key_map();
    }
     ...
     */
    inline const_key_map_iterator_t end() const
    {
      return end_key_map();
    }
     ...
     */
    inline const_value_map_iterator_t find_value(T const & t) const
    {
      return _value_map.find(t);
    }
