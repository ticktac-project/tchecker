...
/*!
 ...
 \tparam T : type of waiting elements
 */
template <class T> class lifo_waiting_t {
public:
  /*!
   ...
   */
  inline void insert(T const & t) { _stack.push(t); }
   ...
   */
  inline void remove_first() { _stack.pop(); }
   ...
   */
  inline T const & first() const { return _stack.top(); }
...
/*!
 ...
 \tparam T : type of waiting elements
 */
template <class T> class fifo_waiting_t {
public:
  /*!
   \brief Type of waiting element
   */
   ...
   */
  inline void insert(T const & t) { _queue.push(t); }
   ...
   */
  inline void remove_first() { _queue.pop(); }
   ...
   */
  inline T const & first() const { return _queue.front(); }
...
/*!
 ...
 predicate.
 */
template <class W> class filter_waiting_t : public W {
public:
  /*!
   \brief Type of waiting element
   */
