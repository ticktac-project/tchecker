...
public:
  ...
  /*!
   ...
   counted
   */
  template <class LOCATION> inline void error(LOCATION const & l, std::string const & msg)
  {
    message(l, "ERROR, " + msg);
    ++_error_count;
  }
  ...
  /*!
   ...
   counted
   */
  template <class LOCATION> void warning(LOCATION const & l, std::string const & msg)
  {
   ...
   */
  inline constexpr std::size_t error_count() const { return _error_count; }

  /*!
   \brief Accessor
   \return Number of warning messages in this log
   */
  inline constexpr std::size_t warning_count() const { return _warning_count; }
...
private:
   ...
   */
  template <class LOCATION> void message(LOCATION const & l, std::string const & msg)
  {
    if (_os != nullptr) {
      *_os << l << ": ";
      message(msg);
