 ...
 */
template <class ZONE_SEMANTICS> class explored_model_t {
public:
 ...
 */
template <class EXPLORED_MODEL, template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER,
          template <class NPTR> class WAITING>
void run(tchecker::parsing::system_declaration_t const & sysdecl, tchecker::explore::options_t const & options,
         tchecker::log_t & log)
{
  ...
  graph_t graph(model.system().name(),
                ...
                options.output_stream(), EXPLORED_MODEL::node_outputter_args(model),
         ...
         tchecker::log_t & log)
{
  ...
  case tchecker::explore::options_t::FSM:
    tchecker::explore::details::run<tchecker::explore::details::fsm::explored_model_t, GRAPH_OUTPUTTER, WAITING>(sysdecl,
                                                                                                                 options, log);
    break;
  case tchecker::explore::options_t::TA:
    tchecker::explore::details::run<tchecker::explore::details::ta::explored_model_t, GRAPH_OUTPUTTER, WAITING>(sysdecl,
                                                                                                                options, log);
    break;
  ...
  case tchecker::explore::options_t::ZG_NON_ELAPSED_NOEXTRA:
    tchecker::explore::details::run<
        tchecker::explore::details::zg::ta::explored_model_t<tchecker::zg::ta::non_elapsed_no_extrapolation_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  ...
  case tchecker::explore::options_t::ZG_NON_ELAPSED_EXTRAM_PLUS_L:
    tchecker::explore::details::run<
        tchecker::explore::details::zg::ta::explored_model_t<tchecker::zg::ta::non_elapsed_extraMplus_local_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::explore::options_t::ZG_NON_ELAPSED_EXTRALU_G:
    tchecker::explore::details::run<
        tchecker::explore::details::zg::ta::explored_model_t<tchecker::zg::ta::non_elapsed_extraLU_global_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::explore::options_t::ZG_NON_ELAPSED_EXTRALU_L:
    tchecker::explore::details::run<
        tchecker::explore::details::zg::ta::explored_model_t<tchecker::zg::ta::non_elapsed_extraLU_local_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
