 ...
 */
template <class STATE> class node_t : public tchecker::graph::node_with_id_t, public STATE {
public:
  /*!
   \brief Constructor
  ...
  node_t(tchecker::node_id_t id, SARGS &&... sargs) : tchecker::graph::node_with_id_t(id), STATE(std::forward<SARGS>(sargs)...)
  {
  }
  ...
  */
  template <class... SARGS>
  node_t(tchecker::explore::node_t<STATE> const & node, tchecker::node_id_t id, SARGS &&... sargs)
 ...
 */
template <class TRANSITION> using edge_t = TRANSITION;
 ...
 */
template <class STATE> class allocation_size_t<tchecker::explore::node_t<STATE>> {
public:
