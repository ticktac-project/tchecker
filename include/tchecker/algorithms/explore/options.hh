...
public:
  ...
  options_t(tchecker::range_t<MAP_ITERATOR> const & range, tchecker::log_t & log)
      : _output_format(tchecker::explore::options_t::RAW), _explored_model(tchecker::explore::options_t::UNKNOWN),
        _os(&std::cout), _search_order(tchecker::explore::options_t::DFS), _block_size(10000)
  {
   ...
   */
  static constexpr struct option const getopt_long_options_long[] = {{"format", required_argument, 0, 'f'},
