...
public:
  ...
  options_t(tchecker::range_t<MAP_ITERATOR> const & range, tchecker::log_t & log)
      : _node_covering(INCLUSION), _output_format(tchecker::covreach::options_t::RAW),
        _algorithm_model(tchecker::covreach::options_t::UNKNOWN), _os(&std::cout),
        _search_order(tchecker::covreach::options_t::DFS), _block_size(10000), _nodes_table_size(65536), _stats(0)
  {
   ...
   */
  static constexpr struct option const getopt_long_options_long[] = {{"cover", required_argument, 0, 'c'},
