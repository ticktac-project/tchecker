 ...
 */
template <class ZONE_SEMANTICS> class algorithm_model_t {
public:
  ...
  static inline key_t node_to_key(node_ptr_t const & node) { return tchecker::ta::hash_value(*node); }
  ...
  class node_lt_t {
  public:
    bool operator()(node_ptr_t const & n1, node_ptr_t const & n2) const { return tchecker::zg::lexical_cmp(*n1, *n2) < 0; }
  };

  static std::tuple<> state_predicate_args(model_t const & model) { return std::tuple<>(); }

  static std::tuple<model_t const &> zone_predicate_args(model_t const & model) { return std::tuple<model_t const &>(model); }
...
public:
  ...
  node_outputter_args(model_t const & model)
  {
    return std::tuple<tchecker::intvar_index_t const &, tchecker::clock_index_t const &, tchecker::clock_index_t const &>(
        model.flattened_integer_variables().index(), model.flattened_offset_clock_variables().index(),
 ...
 */
template <template <class NODE_PTR, class STATE_PREDICATE> class COVER_NODE, class ALGORITHM_MODEL,
          template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER, template <class NPTR> class WAITING>
void run(tchecker::parsing::system_declaration_t const & sysdecl, tchecker::covreach::options_t const & options,
         tchecker::log_t & log)
{
  ...
  graph_t graph(gc,
                ...
                options.block_size(), options.nodes_table_size(), ALGORITHM_MODEL::node_to_key, cover_node);
  ...
  if (options.output_format() == tchecker::covreach::options_t::DOT) {
    tchecker::covreach::dot_outputter_t<typename ALGORITHM_MODEL::node_outputter_t> dot_outputter(
        false, ALGORITHM_MODEL::node_outputter_args(model));

    dot_outputter.template output<graph_t, typename ALGORITHM_MODEL::node_lt_t>(options.output_stream(), graph,
                                                                                model.system().name());
  }
...
/*!
 ...
 Every error and warning has been reported to log.
 */
template <class ALGORITHM_MODEL, template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER,
          template <class NPTR> class WAITING>
void run_async_zg(tchecker::parsing::system_declaration_t const & sysdecl, tchecker::covreach::options_t const & options,
                  tchecker::log_t & log)
{
...
template <class ALGORITHM_MODEL, template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER,
          template <class NPTR> class WAITING>
void run_zg(tchecker::parsing::system_declaration_t const & sysdecl, tchecker::covreach::options_t const & options,
            tchecker::log_t & log)
{
         ...
         tchecker::log_t & log)
{
  ...
  case tchecker::covreach::options_t::ASYNC_ZG_ELAPSED_EXTRALU_PLUS_L:
    tchecker::covreach::details::run_async_zg<
        ...
        GRAPH_OUTPUTTER, WAITING>(sysdecl, options, log);
    break;
  ...
  case tchecker::covreach::options_t::ZG_ELAPSED_NOEXTRA:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_no_extrapolation_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_ELAPSED_EXTRAM_G:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_extraM_global_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_ELAPSED_EXTRAM_L:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_extraM_local_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_ELAPSED_EXTRAM_PLUS_G:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_extraMplus_global_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_ELAPSED_EXTRAM_PLUS_L:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_extraMplus_local_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_ELAPSED_EXTRALU_G:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_extraLU_global_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_ELAPSED_EXTRALU_L:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_extraLU_local_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_ELAPSED_EXTRALU_PLUS_G:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_extraLUplus_global_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_ELAPSED_EXTRALU_PLUS_L:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::elapsed_extraLUplus_local_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  ...
  case tchecker::covreach::options_t::ZG_NON_ELAPSED_EXTRAM_G:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::non_elapsed_extraM_global_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_NON_ELAPSED_EXTRAM_L:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::non_elapsed_extraM_local_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  ...
  case tchecker::covreach::options_t::ZG_NON_ELAPSED_EXTRALU_G:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::non_elapsed_extraLU_global_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
  case tchecker::covreach::options_t::ZG_NON_ELAPSED_EXTRALU_L:
    tchecker::covreach::details::run_zg<
        tchecker::covreach::details::zg::ta::algorithm_model_t<tchecker::zg::ta::non_elapsed_extraLU_local_t>, GRAPH_OUTPUTTER,
        WAITING>(sysdecl, options, log);
    break;
