 ...
 */
template <class NODE_PTR> class accepting_labels_t {
public:
  /*!
   \brief Constructor
   ...
   */
  tchecker::covreach::accepting_labels_t<NODE_PTR> & operator=(tchecker::covreach::accepting_labels_t<NODE_PTR> &&) = default;
