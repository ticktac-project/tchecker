 ...
 */
template <class NODE_PTR> inline bool valid_cover(NODE_PTR const & n1, NODE_PTR const & n2)
{
  assert(n2->is_active());
  assert(n1->is_active());
 ...
 */
template <class NODE_PTR> class cover_zone_inclusion_t {
public:
  /*!
   ...
   */
  template <class MODEL> explicit cover_zone_inclusion_t(MODEL const & model) {}
   ...
   */
  bool operator()(NODE_PTR const & n1, NODE_PTR const & n2) { return (n1->zone() <= n2->zone()); }
};
...
/*!
 ...
 \tparam NODE_PTR : type of pointer to node, *NODE_PTR should derive from tchecker::zg::details::state_t
 */
template <class NODE_PTR> class cover_zone_alu_global_t {
public:
  /*!
   \brief Type of pointer to node
   */
  ...
  explicit cover_zone_alu_global_t(MODEL const & model) : _L(model.global_lu_map().L()), _U(model.global_lu_map().U())
  {
  }
  ...
  /*!
   ...
   otherwise
   */
  bool operator()(NODE_PTR const & n1, NODE_PTR const & n2) { return n1->zone().alu_le(n2->zone(), _L.get(), _U.get()); }
...
/*!
 ...
 \tparam NODE_PTR : type of pointer to node, *NODE_PTR should derive from tchecker::zg::details::state_t
 */
template <class NODE_PTR> class cover_zone_alu_local_t {
public:
  /*!
   \brief Type of pointer to node
   */
   ...
   */
  template <class MODEL> explicit cover_zone_alu_local_t(MODEL const & model) : _local_lu_map(model.local_lu_map())
  {
...
/*!
 ...
 \tparam NODE_PTR : type of pointer to node, *NODE_PTR should derive from tchecker::zg::details::state_t
 */
template <class NODE_PTR> class cover_zone_am_global_t {
public:
  /*!
   \brief Type of pointer to node
   */
   ...
   */
  template <class MODEL> explicit cover_zone_am_global_t(MODEL const & model) : _M(model.global_m_map().M()) {}
  ...
  /*!
   ...
   otherwise
   */
  bool operator()(NODE_PTR const & n1, NODE_PTR const & n2) { return n1->zone().am_le(n2->zone(), _M.get()); }
...
/*!
 ...
 \tparam NODE_PTR : type of pointer to node, *NODE_PTR should derive from tchecker::zg::details::state_t
 */
template <class NODE_PTR> class cover_zone_am_local_t {
public:
  /*!
   \brief Type of pointer to node
   */
   ...
   */
  template <class MODEL> explicit cover_zone_am_local_t(MODEL const & model) : _local_m_map(model.local_m_map())
  {
  ...
  /*!
   \brief Copy constructor
   */
  cover_zone_am_local_t(tchecker::covreach::details::cover_zone_am_local_t<NODE_PTR> const & c) : _local_m_map(c._local_m_map)
  {
  ...
  /*!
   \brief Destructor
   */
  ~cover_zone_am_local_t() { tchecker::clockbounds::deallocate_map(_M); }
 ...
 */
template <class NODE_PTR> class cover_sync_zone_inclusion_t {
public:
  /*!
   \brief Type of pointer to node
   */
  ...
  /*!
   ...
   \tparam MODEL : type of model
   */
  template <class MODEL> explicit cover_sync_zone_inclusion_t(MODEL const & model) {}
  ...
  /*!
   ...
   \return true if the zone in n1 is included in the zone in n2, false otherwise
   */
  bool operator()(NODE_PTR const & n1, NODE_PTR const & n2) { return (n1->sync_zone() <= n2->sync_zone()); }
};
...
public:
  ...
  bool operator()(NODE_PTR const & n1, NODE_PTR const & n2)
  {
    return (tchecker::covreach::details::valid_cover(n1, n2) && STATE_PREDICATE::operator()(n1, n2) &&
...
using cover_inclusion_t =
    tchecker::covreach::details::cover_node_t<NODE_PTR, STATE_PREDICATE,
                                              tchecker::covreach::details::cover_zone_inclusion_t<NODE_PTR>>;
