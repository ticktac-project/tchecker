...
public:
   ...
   */
  bool is_active() const { return (_active == 1); }

  /*!
   \brief Make inactive
   \post this node is inactive
   */
  void make_inactive() { _active = 0; }
 ...
 */
template <class NODE_PTR> bool active_node_filter(NODE_PTR const & node) { return node->is_active(); }
 ...
 */
template <class W> class active_waiting_t : public tchecker::filter_waiting_t<W> {
public:
  /*!
  ...
  /*!
   \brief Constructor
   */
  active_waiting_t() : tchecker::filter_waiting_t<W>(tchecker::covreach::details::active_node_filter<node_ptr_t>) {}
  ...
  /*!
   \brief Move-assignment operator
   */
  tchecker::covreach::details::active_waiting_t<W> & operator=(tchecker::covreach::details::active_waiting_t<W> &&) = default;
   ...
   */
  void remove(node_ptr_t const & n) { n->make_inactive(); }
};
