 ...
 */
template <class STATE, class TRANSITION, class INITIAL_ITERATOR, class OUTGOING_EDGES_ITERATOR,
...
public:
   ...
   */
  virtual enum tchecker::state_status_t initialize(STATE & s, TRANSITION & t, INITIAL_ITERATOR_VALUE const & v) = 0;
