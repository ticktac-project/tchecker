 ...
 */
template <class STATE_ALLOCATOR, class TRANSITION_ALLOCATOR> class allocator_t {
public:
  /*!
  ...
  allocator_t(std::tuple<tchecker::gc_t &, std::tuple<SA_ARGS...>, std::tuple<TA_ARGS...>> && t)
      : allocator_t(std::get<0>(t), std::forward<std::tuple<SA_ARGS...>>(std::get<1>(t)),
   ...
   */
  template <class... ARGS> inline state_ptr_t construct_state(ARGS &&... args)
  {
  ...
  /*!
   ...
   \return pointer to a newly allocated state constructed from args
   */
  template <class... ARGS> inline state_ptr_t construct_state(std::tuple<ARGS...> && args)
  {
   ...
   */
  template <class... ARGS> inline state_ptr_t construct_from_state(state_ptr_t const & state, ARGS &&... args)
  {
  ...
  /*!
   ...
   \return pointer to a newly allocated state constructed from state and args
   */
  template <class... ARGS> inline state_ptr_t construct_from_state(state_ptr_t const & state, std::tuple<ARGS...> && args)
  {
    return std::apply(&tchecker::ts::allocator_t<STATE_ALLOCATOR, TRANSITION_ALLOCATOR>::_construct_from_state<ARGS...>,
   ...
   */
  bool destruct_state(state_ptr_t & p) { return _state_allocator.destruct(p); }
   ...
   */
  template <class... ARGS> inline transition_ptr_t construct_transition(ARGS &&... args)
  {
  ...
  /*!
   ...
   \return pointer to a newly allocated transition constructed from args
   */
  template <class... ARGS> inline transition_ptr_t construct_transition(std::tuple<ARGS...> && args)
  {
    return std::apply(&tchecker::ts::allocator_t<STATE_ALLOCATOR, TRANSITION_ALLOCATOR>::_construct_transition<ARGS...>,
                      std::tuple_cat(std::make_tuple(this), args));
  }
   ...
   */
  bool destruct_transition(transition_ptr_t & p) { return _transition_allocator.destruct(p); }
...
protected:
  /*!
   ...
   \return pointer to a newly allocated state constructed from args
   */
  template <class... ARGS> inline state_ptr_t _construct_state(ARGS &&... args) { return _state_allocator.construct(args...); }
  ...
  /*!
   ...
   \return pointer to a newly allocated state constructed from state and args
   */
  template <class... ARGS> inline state_ptr_t _construct_from_state(state_ptr_t const & state, ARGS &&... args)
  {
   ...
   */
  template <class... ARGS> inline transition_ptr_t _construct_transition(ARGS &&... args)
  {
