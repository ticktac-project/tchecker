...
TEST_CASE("translation clocks <-> offset variables", "[offset_dbm]")
{
  ...
  SECTION("reference/offset variable -> clock")
  {
    for (tchecker::clock_id_t i = 0; i < refcount; ++i)
      REQUIRE(tchecker::offset_dbm::clock_id(i, refcount) == tchecker::REFCLOCK_ID);
...
TEST_CASE("is_positive, structural test for offset DBMs", "[offset_dbm]")
{
  ...
  {
    tchecker::dbm::db_t offset_dbm[refcount * refcount] = {tchecker::dbm::LE_ZERO, tchecker::dbm::LT_INFINITY,
                                                           tchecker::dbm::LT_INFINITY, tchecker::dbm::LE_ZERO};
...
TEST_CASE("is_synchronized, structural test for offset DBMs", "[offset_dbm]")
{
  ...
  {
    tchecker::dbm::db_t offset_dbm[refcount * refcount] = {tchecker::dbm::LE_ZERO, tchecker::dbm::LE_ZERO,
                                                           tchecker::dbm::LE_ZERO, tchecker::dbm::LE_ZERO};
